...
def home():
    ...
    def landing():
        ...
        Button(home,text='search',command=lambda:search_book(home,search_books),bg='black', fg='white', font=('Courier',25)).pack(pady=18)
        Button(home,text ="add book",command=lambda:add_books(home,add_book),bg='black', fg='white', font=('Courier',25)).pack(pady=18)
        Button(home,text='update book',command=lambda:update_books(home,update_book),bg='black', fg='white', font=('Courier',25)).pack(pady=18)
        Button(home,text='delete book',command=lambda:delete_books(home,delete_book),bg='black', fg='white', font=('Courier',25)).pack(pady=18)   
        Button(home,text='issue book',command=lambda:issue_books(home,issue_book),bg='black', fg='white', font=('Courier',25)).pack(pady=18)
        Button(home,text='return book',command=lambda:return_books(home,return_book),bg='black', fg='white', font=('Courier',25)).pack(pady=18)
        home.pack(expand=1,fill=X)
    landing()
    main.mainloop()  
home()
